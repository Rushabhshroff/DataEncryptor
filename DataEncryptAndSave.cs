    ...
    namespace Encryption
    {
        ...
        public class Encoder
        {
            ...
            public static string EncodeToMD5(string value)
            {
                ...
                var input = ASCIIEncoding.ASCII.GetBytes(value);
                MD5 md = MD5.Create();
            ...
            /// <summary>
            /// Endcodes int to MD5Hash
            /// </summary>
            /// <param name="value"></param>
            /// <returns></returns>
            public static string EncodeToMD5(int value)
            {
                StringBuilder builder = new StringBuilder();
                var input = ASCIIEncoding.ASCII.GetBytes(value.ToString());
                MD5 md = MD5.Create();
                var Hash = md.ComputeHash(input);
                foreach (byte b in Hash)
                {
            ...
            /// <summary>
            /// Encodes float to MD5Hash
            /// </summary>
            /// <param name="value"></param>
            /// <returns></returns>
            public static string EncodeToMD5(float value)
            {
                StringBuilder builder = new StringBuilder();
                var input = ASCIIEncoding.ASCII.GetBytes(value.ToString());
                MD5 md = MD5.Create();
			...
			/// <summary>
			/// Encodes long to MD5Hash
			/// </summary>
			/// <param name="value"></param>
			/// <returns></returns>
			public static string EncodeToMD5(long value)
			{
				StringBuilder builder = new StringBuilder();
				var input = ASCIIEncoding.ASCII.GetBytes(value.ToString());
				MD5 md = MD5.Create();
			...
			/// <summary>
			/// Encodes decimal to MD5Hash
			/// </summary>
			/// <param name="value"></param>
			/// <returns></returns>
			public static string EncodeToMD5(decimal value)
			{
				StringBuilder builder = new StringBuilder();
				var input = ASCIIEncoding.ASCII.GetBytes(value.ToString());
				MD5 md = MD5.Create();
			...
			/// <summary>
			/// Encodes double to MD5Hash
			/// </summary>
			/// <param name="value"></param>
			/// <returns></returns>
			public static string EncodeToMD5(double value)
			{
				StringBuilder builder = new StringBuilder();
				var input = ASCIIEncoding.ASCII.GetBytes(value.ToString());
				MD5 md = MD5.Create();
